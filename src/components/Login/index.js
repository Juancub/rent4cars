...
export function Login() {
  ...
  const {login, reservaUsuario} = useContext(UserContext);
  ...
  return (
    <section className='login'>
            ...
            <form className='form-login'  onSubmit={login}>        
              <label>Correo Electrónico<input type="email" required name='email'/></label>
              <label>Contraseña<input type="password" required minLength="6" name='pass' /></label>
